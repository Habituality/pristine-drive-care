...
const testimonials = [
  ...
  { name: "Erik S.", text: "Bilen hade inte sett så bra ut på 10 år. Proffsigt och snabbt. Rekommenderas varmt!" },
  { name: "Maria K.", text: "Smidig bokning och otroligt nöjd med biltvätten. Fem stjärnor utan tvekan." },
];
