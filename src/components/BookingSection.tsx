      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-muted-foreground font-body max-w-lg mx-auto">
            Välj en eller flera tjänster, anpassa paket och tillägg – se priset direkt. Klicka sedan "Boka nu" för att slutföra.
          </p>
        </div>
          ...
          {showForm && (
            ...
            >
              ...
              <input type="date" required
                ...
                value={state.date} onChange={(e) => set("date", e.target.value)} />
